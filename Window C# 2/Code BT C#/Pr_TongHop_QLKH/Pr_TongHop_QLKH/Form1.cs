...
namespace Pr_TongHop_QLKH
{
    public partial class Form1 : Form
    {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Chưa chọn khách hàng không thể xóa?");
                return;
            }
            ListViewItem lvi = lvKhachHang.SelectedItems[0];
            int ma =(int) lvi.Tag;
            DialogResult ret = MessageBox.Show("Có chắc chắn muốn xóa mã [" + ma + "]?",
                "Xác nhận xóa mã", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
